...
public class ContextLabel: UILabel, NSLayoutManagerDelegate {
    ...
    public override init(frame: CGRect) {
        ...
        self.attachTapHandler()//自己加的,为了能达到长按复制文本
        setupTextSystem()
    }

    ////////////////////MARK: 造车轮
    override public func canBecomeFirstResponder() -> Bool {//成为第一响应
        return true
    }
    ...
    func attachTapHandler() -> Void{
        ...
        let touch = UILongPressGestureRecognizer(target: self, action: #selector(ContextLabel.handlerTap(_:)))
